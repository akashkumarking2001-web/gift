        ...
        <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-purple-500 via-pink-500 to-rose-500 flex items-center justify-center p-4 py-16">
            ...
            <div className="relative z-10 max-w-6xl w-full">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
                    {defaultData.moments.map((moment, index) => (
                        <motion.div
                            ...
                            className="bg-white/95 backdrop-blur-sm rounded-[2.5rem] shadow-2xl p-8 relative overflow-hidden group/card border-2 border-white/50"
                        >
                            {/* Gradient Accent */}
                ...
                >
                    <motion.button
                        onClick={onNext}
                        className="group relative overflow-hidden px-16 py-8 rounded-[2.5rem] bg-white text-purple-600 font-black text-sm uppercase tracking-[0.4em] shadow-[0_25px_60px_-15px_rgba(255,255,255,0.4)] hover:shadow-[0_35px_80px_-15px_rgba(255,255,255,0.5)] transition-all"
                        whileHover={{ scale: 1.05, y: -5 }}
                        whileTap={{ scale: 0.95 }}
                    >
                        <motion.div
                            className="absolute inset-0 bg-gradient-to-r from-purple-500/10 via-pink-500/10 to-rose-500/10 translate-x-full group-hover:translate-x-0 transition-transform duration-700"
                        />
