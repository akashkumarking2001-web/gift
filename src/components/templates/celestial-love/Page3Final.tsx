    ...
    return (
        <div className="min-h-screen relative overflow-hidden bg-[#050510] flex flex-col items-center justify-center p-8 text-center text-blue-50">
            ...
            <div className="relative z-10 max-w-4xl">
                {/* Floating Galactic Success Icon */}
                <motion.div
                    initial={{ scale: 0 }}
                    animate={{ scale: 1.1 }}
                ...
                >
                    <div className="relative">
                        <Heart size={160} fill="#3b82f6" className="text-blue-600 drop-shadow-[0_0_80px_rgba(59,130,246,0.7)]" />
                        <motion.div
                ...
                >
                    <button
                        ...
                        className="px-16 py-6 border border-blue-500/30 bg-blue-600/10 text-blue-400 font-black text-xs md:text-sm uppercase tracking-[0.6em] rounded-full shadow-2xl hover:scale-110 active:scale-95 transition-all text-white"
                    >
                        Retravel the Stars
                    </button>
                    <p className="text-[10px] font-black text-blue-100/20 uppercase tracking-[0.5em] italic">
                        Written in the infinite cosmos
                    </p>
                </motion.div>
            </div>
        </div>
