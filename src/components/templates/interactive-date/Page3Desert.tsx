...
const Page3Desert = ({ data, onNext, isEditing = false, onUpdate }: Page3DesertProps) => {
    ...
    const defaultData = {
        heading: data.heading || "And for dessert?",
    ...
    const icons = [<Cake size={24} />, <IceCream size={24} />, <Cookie size={24} />, <Candy size={24} />];
        ...
        <div className="min-h-screen relative overflow-hidden bg-[#051010] flex flex-col items-center justify-center p-8 text-center">
            ...
            <div className="relative z-10 w-full max-w-4xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 max-w-2xl mx-auto">
                    {defaultData.options.map((option, index) => (
                        ...
                        >
                            ...
                            <span className="text-xl md:text-2xl font-black text-white font-lovely tracking-wide text-left">
                                {option}
                            </span>
                            {isEditing && (
                                <div
                ...
                {selected && (
                    ...
                    >
                        Sweet choice! {selected} coming right up...
                    </motion.p>
                )}
            </div>
        </div>
