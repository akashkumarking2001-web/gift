...
import { Ticket, Sparkles, Star, MoveRight, ShieldCheck, Zap } from 'lucide-react';
        ...
        <div className="min-h-screen relative overflow-hidden bg-[#0d0a05] flex flex-col items-center justify-center p-8 text-center font-outfit isolate">
            ...
            <div className="absolute inset-0 z-0 pointer-events-none">
                <motion.div
                    ...
                    className="absolute inset-0 bg-[radial-gradient(circle_at_25%_25%,rgba(245,158,11,0.15),transparent_50%),radial-gradient(circle_at_75%_75%,rgba(180,130,50,0.15),transparent_50%)]"
                />
            ...
            <div className="relative z-10 max-w-6xl w-full flex flex-col items-center">
                ...
                >
                    <div className="relative p-16 bg-white/[0.03] backdrop-blur-3xl rounded-[5rem] border border-amber-500/20 shadow-[0_50px_100px_-20px_rgba(245,158,11,0.25)] isolate">
                        ...
                        <Ticket size={90} strokeWidth={1} className="text-amber-400 drop-shadow-[0_0_30px_rgba(245,158,11,0.6)] rotate-12" />

                        {/* Floating Micro-Element */}
                        <motion.div
                            animate={{ y: [0, -10, 0] }}
                            transition={{ duration: 4, repeat: Infinity }}
                            className="absolute -top-6 -right-6 p-5 bg-amber-900/20 backdrop-blur-xl rounded-2xl border border-amber-500/30"
                        >
                ...
                <div className="space-y-12 mb-28 text-center max-w-5xl">
                    <motion.div
                        ...
                        className="inline-flex items-center gap-4 bg-amber-900/10 backdrop-blur-xl px-12 py-3.5 rounded-full border border-amber-800/20 mx-auto"
                    >
                        <Star size={14} className="text-amber-400 fill-current animate-pulse" />
                        <span className="text-amber-100/50 font-black uppercase tracking-[0.6em] text-[10px]">Registry Sequence 01</span>
                        <Zap size={14} className="text-amber-400 fill-current opacity-30" />
                    </motion.div>
            ...
            <div className="fixed bottom-12 right-12 flex flex-col items-end gap-2 opacity-10">
                <div className="font-romantic text-6xl text-amber-700 italic">Redemption</div>
                <div className="h-[1px] w-48 bg-amber-700" />
                <span className="text-[10px] font-black tracking-widest text-white uppercase">System: Coupon V4</span>
            </div>
