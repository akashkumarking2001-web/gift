      ...
      <header className="sticky top-0 z-50 glass-header px-6 py-4 flex items-center justify-between border-b border-white/5">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col leading-tight">
            <h1 className="text-xl font-black tracking-tight text-white group cursor-default flex items-center">
              <span className="gradient-text">Gift</span> Magic
            </h1>
            <span className="text-[8px] font-bold tracking-[0.2em] text-[#f04299]/60 uppercase">Digital Experience</span>
          </div>
        </div>
